...
var foundations_sizes_dist_chakraUiThemeFoundationsSizes = require('./sizes-8458a9c4.cjs.prod.js');
var components_dist_chakraUiThemeComponents = require('./index-d075d4fc.cjs.prod.js');
...
var styles = {
  global: function global(props) {
    return {
      ...
      "*::placeholder": {
        color: themeTools.mode("gray.500", "whiteAlpha.400")(props)
      },
      "*, *::before, &::after": {
