...
var ToastComponent = /*#__PURE__*/React__namespace.memo(function (props) {
  var id = props.id,
  ...
  var _React$useState = React__namespace.useState(duration),
  ...
  var toastStyle = React__namespace.useMemo(function () {
...
function useToastProvider(defaultOptions) {
  ...
  var toast = React__namespace.useMemo(function () {
    /**
 ...
 */
var ToastProvider = /*#__PURE__*/React__namespace.forwardRef(function (props, ref) {
  ...
  var toastList = utils.objectKeys(areas).map(function (position) {
    ...
    return /*#__PURE__*/React__namespace.createElement("ul", {
      ...
      return /*#__PURE__*/React__namespace.createElement(CustomToastComponent, _extends({
        key: toast.id,
        motionVariants: motionVariants
      }, toast));
    })));
  });
  return /*#__PURE__*/React__namespace.createElement(ToastManagerProvider, {
    value: toast
  }, children, /*#__PURE__*/React__namespace.createElement(portal.Portal, null, toastList));
});
...
var Toast = function Toast(props) {
  ...
  }, /*#__PURE__*/React__namespace.createElement(alert.AlertIcon, null, icon), /*#__PURE__*/React__namespace.createElement(system.chakra.div, {
    flex: "1",
    maxWidth: "100%"
...
function createRenderToast(options) {
  ...
  var renderToast = function renderToast(props) {
    ...
    return /*#__PURE__*/React__namespace.createElement(ToastComponent, _extends({}, props, options));
  };
...
function useToast(defaultOptions) {
  var _useChakra = system.useChakra(),
      theme = _useChakra.theme;

  var toastContext = useToastManager();
  var latestToastContextRef = hooks.useLatestRef(toastContext);
...
function createStandaloneToast(_temp) {
  ...
  var ToastContainer = function ToastContainer() {
    return /*#__PURE__*/React__namespace.createElement(system.ThemeProvider, {
      theme: theme
    }, /*#__PURE__*/React__namespace.createElement(system.ColorModeContext.Provider, {
      value: colorModeContextValue
    }, /*#__PURE__*/React__namespace.createElement(ToastProvider, {
      ref: ref,
      defaultOptions: defaultOptions,
      motionVariants: motionVariants,
  ...
  toast.notify = (_ref$current$notify = (_ref$current3 = ref.current) == null ? void 0 : _ref$current3.notify) != null ? _ref$current$notify : utils.noop;
  toast.closeAll = (_ref$current$closeAll = (_ref$current4 = ref.current) == null ? void 0 : _ref$current4.closeAll) != null ? _ref$current$closeAll : utils.noop;
  toast.close = (_ref$current$close = (_ref$current5 = ref.current) == null ? void 0 : _ref$current5.close) != null ? _ref$current$close : utils.noop;
  toast.isActive = (_ref$current$isActive = (_ref$current6 = ref.current) == null ? void 0 : _ref$current6.isActive) != null ? _ref$current$isActive : utils.noop;
  return {
